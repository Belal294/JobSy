  ...
  return (
    <div className="flex-1 bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="mb-6 flex space-x-3 border-b border-gray-200 pb-2">
        <button className="px-5 py-2 bg-blue-600 text-white rounded-md text-sm font-semibold shadow-md hover:bg-blue-700 transition-colors">Jobs</button>
        <button className="px-5 py-2 bg-gray-100 text-gray-700 rounded-md text-sm font-medium hover:bg-gray-200 transition-colors">Candidates</button>
        <button className="px-5 py-2 bg-gray-100 text-gray-700 rounded-md text-sm font-medium hover:bg-gray-200 transition-colors">Messages</button>
      </div>

      {/* Back Link */}
      <div className="mb-6">
        <a href="#" className="text-blue-600 text-sm flex items-center font-medium hover:underline">
          &lt; Back to all jobs
        </a>
      </div>
      ...
      <div className="bg-white p-5 rounded-lg shadow-md mb-6 border border-gray-100">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold text-gray-800 mb-1">Web Developer</h1>
            <p className="text-gray-600 text-sm">Global Inc. - Miami, Florida</p>
          </div>
      ...
      <div className="bg-white p-5 rounded-lg shadow-md mb-6 border border-gray-100">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            <h3 className="text-4xl font-extrabold text-blue-600">122</h3>
            <div className="ml-3 flex items-center">
              <span className="text-base text-gray-600">Clicks This Week</span>
              <Info size={18} className="ml-2 text-blue-500 cursor-help" />
            </div>
          </div>
        </div>

        {/* Graph (Enhanced with more detailed styling) */}
        ...
        <button className="w-full py-3 bg-blue-100 text-blue-600 rounded-md text-base font-semibold hover:bg-blue-200 transition-colors">
